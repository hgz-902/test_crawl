...
DEFAULT_ROLLUP_TIME = "10:10"
KST = timezone(timedelta(hours=9))


# live workflow_records.json을 rollup archive로 옮기고 원본을 제거한다.
...
# archive 경로 workflow records 값을 계산해 반환한다.
...
# sorted archive remove source를 파일에 기록한다.
...
# workflow records payload latest first를 정렬한다.
...
# 오래된 rollup archive 목록을 보존 기준에 맞춰 정리한다.
