...
- allowed files: configs/�κ���Ʈ����.json and validation notes only if needed
- acceptance criteria: �κ���Ʈ���� appears in config list, config loads, crawler reaches at least one detail page, extracts title/body, and source code files remain untouched by this slice.
